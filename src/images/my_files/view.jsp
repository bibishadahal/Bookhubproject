...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-12-22-abtest-dsktp-v2.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
...
usi_js.click_cta = function(){
    ...
    if (usi_app.is_cart_page) {
      if (usi_cookies.value_exists("usi_prod_type_1")) {
        if (usi_cookies.get("usi_prod_type_1") == "video") {
        	destination_url = "https://www.shutterstock.com/pricing/video";  
        } else if (usi_cookies.get("usi_prod_type_1") == "music") {
        	destination_url = "https://www.shutterstock.com/pricing/music";  
        }
      }
    } else {
      if (usi_app.is_music()) {
        destination_url = "https://www.shutterstock.com/pricing/music";
      } else if (usi_app.is_video()) {
        destination_url = "https://www.shutterstock.com/pricing/video";
      } else if (usi_app.is_image()) {
        destination_url = "https://www.shutterstock.com/pricing";
      }
    }
...
usi_js.display_vars.p1_html = [
	'<div class="usi_sr_only">shutterstock flex. Get images, videos, and music free for 1 month.</div>',
	...
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Start Now"></button>',
].join('');
